...
async function getDocumentById(id) {
    try {
        ...
        const doc = await __turbopack_context__.A("[project]/models/Document.ts [app-rsc] (ecmascript, async loader)").then((mod)=>mod.default.findById(id).lean());
        if (!doc) {
            return null;
        }
        return {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__d91ddd82._.js.map