...
async function GET(req) {
    ...
    if (!token) return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$0$2e$7_react$2d$dom$40$19$2e$2$2e$0_react$40$19$2e$2$2e$0_$5f$react$40$19$2e$2$2e$0$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        user: null
    }, {
        status: 200
    });
    try {
        const decoded = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$jsonwebtoken$40$9$2e$0$2e$3$2f$node_modules$2f$jsonwebtoken$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].verify(token, process.env.JWT_SECRET);
        const user = await __TURBOPACK__imported__module__$5b$project$5d2f$models$2f$User$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].findById(decoded.id).lean();
        if (!user) return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$0$2e$7_react$2d$dom$40$19$2e$2$2e$0_react$40$19$2e$2$2e$0_$5f$react$40$19$2e$2$2e$0$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            user: null
        }, {
            status: 404
        });
        // Fetch documents from new Document model
        const documents = await __turbopack_context__.A("[project]/models/Document.ts [app-route] (ecmascript, async loader)").then((mod)=>mod.default.find({
                userId: user._id
            }).sort({
                createdAt: -1
            }).lean());
        ...
        let ninRecord = null;
        if (user.nin) {
            ninRecord = await __turbopack_context__.A("[project]/models/NIN.ts [app-route] (ecmascript, async loader)").then((mod)=>mod.default.findOne({
                    nin: user.nin
                }).lean());
        }
...
//# sourceMappingURL=%5Broot-of-the-server%5D__a7784ab8._.js.map