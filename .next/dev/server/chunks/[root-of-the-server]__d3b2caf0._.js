...
async function GET(req) {
    ...
    try {
        ...
        const vault = await __TURBOPACK__imported__module__$5b$project$5d2f$models$2f$Vault$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].findById(user.vaultId).lean();
        // Fetch NIN record if user has a NIN
        let ninRecord = null;
        if (user.nin) {
            ninRecord = await __TURBOPACK__imported__module__$5b$project$5d2f$models$2f$NIN$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].findOne({
                nin: user.nin
            }).lean();
        }
...
//# sourceMappingURL=%5Broot-of-the-server%5D__d3b2caf0._.js.map