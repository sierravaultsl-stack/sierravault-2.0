...
"[project]/models/Vault.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$models$2f$NIN$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/models/NIN.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$models$2f$Vault$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/models/Vault.ts [app-route] (ecmascript)");
...
async function POST(req) {
    ...
    const { email, password, telephone, nin, surname, dob, dateOfExpiry, personalIdNumber } = body;
    ...
    if (nin) {
        ...
        const ninRecord = await __TURBOPACK__imported__module__$5b$project$5d2f$models$2f$NIN$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].findOne({
            nin
        });
        if (!ninRecord) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$0$2e$7_react$2d$dom$40$19$2e$2$2e$0_react$40$19$2e$2$2e$0_$5f$react$40$19$2e$2$2e$0$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        ...
        if (ninRecord.surname.toLowerCase() !== surname.toLowerCase() || ninRecord.dob.toISOString() !== new Date(dob).toISOString() || ninRecord.dateOfExpiry.toISOString() !== new Date(dateOfExpiry).toISOString() || ninRecord.personalIdNumber !== personalIdNumber) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$0$2e$7_react$2d$dom$40$19$2e$2$2e$0_react$40$19$2e$2$2e$0_$5f$react$40$19$2e$2$2e$0$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
    ...
    // Hash password
    const hashed = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$bcryptjs$40$3$2e$0$2e$3$2f$node_modules$2f$bcryptjs$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].hash(password, 12);
    // Generate IDs upfront to solve circular dependency
    const newUserId = new __TURBOPACK__imported__module__$5b$externals$5d2f$mongoose__$5b$external$5d$__$28$mongoose$2c$__cjs$29$__["default"].Types.ObjectId();
    const newVaultId = new __TURBOPACK__imported__module__$5b$externals$5d2f$mongoose__$5b$external$5d$__$28$mongoose$2c$__cjs$29$__["default"].Types.ObjectId();
    // Create vault with known userId
    await __TURBOPACK__imported__module__$5b$project$5d2f$models$2f$Vault$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].create({
        _id: newVaultId,
        userId: newUserId
    });
    ...
    const token = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$jsonwebtoken$40$9$2e$0$2e$3$2f$node_modules$2f$jsonwebtoken$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].sign({
        id: user._id
...
//# sourceMappingURL=%5Broot-of-the-server%5D__d6bc308a._.js.map